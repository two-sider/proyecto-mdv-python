...
3. La capa de datos guarda o recupera tareas con prioridad, fecha y notas.
4. El modelo estandariza la estructura que circula entre capas.
5. La vista muestra el resultado final, los filtros activos, el orden aplicado y el detalle de la tarea seleccionada.
